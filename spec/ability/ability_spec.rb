...
describe 'User' do
  describe 'Abilities' do
    ...
    context 'when user is not signed in' do
      ...
      it { is_expected.not_to be_able_to(:new, Registration.new(conference_id: conference_with_closed_registration.id)) }
      it { is_expected.not_to be_able_to(:create, Registration.new(conference_id: conference_with_closed_registration.id)) }
    ...
    context 'when user is signed in' do
      ...
      context 'when user is not a speaker with event confirmed' do
        ...
        context 'when the registration is closed' do
          ...
          it { is_expected.not_to be_able_to(:new, Registration.new(conference: conference)) }
          it { is_expected.not_to be_able_to(:create, Registration.new(conference: conference)) }
        end
        ...
        context 'when registrations are open' do
          ...
          it { is_expected.to be_able_to(:new, Registration.new(conference: conference)) }
          it { is_expected.to be_able_to(:create, Registration.new(conference: conference)) }
      ...
      xit 'fails after Rails 7 upgrade' do
        expect(subject).to be_able_to(:create, user_event_with_cfp.commercials.new)
      end

      xit 'fails after Rails 7 upgrade' do
        expect(subject).to be_able_to(:manage, user_commercial)
      end
