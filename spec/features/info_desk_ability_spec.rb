...
feature 'Has correct abilities' do
  ...
  context 'when user is info desk' do
    ...
    scenario 'for conference attributes' do
      ...
      expect(page).not_to have_link('Program', href: "/admin/conferences/#{conference.short_title}/program")
      expect(page).not_to have_link('Call for Papers',
                                    href: "/admin/conferences/#{conference.short_title}/program/cfps")
      expect(page).not_to have_link('Events', href: "/admin/conferences/#{conference.short_title}/program/events")
      expect(page).not_to have_link('Tracks', href: "/admin/conferences/#{conference.short_title}/program/tracks")
      ...
      expect(page).not_to have_link('Schedules', href: "/admin/conferences/#{conference.short_title}/schedules")
      expect(page).not_to have_link('Reports', href: "/admin/conferences/#{conference.short_title}/program/reports")
