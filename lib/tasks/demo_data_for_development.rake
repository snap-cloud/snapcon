...
namespace :data do
  ...
  task surveys: :environment do
    ...
    survey_after_conference_active = create(:survey, surveyable: conference, target: :after_conference,
title: 'Survey about the conference', start_date: conference.start_date - 1.day, end_date: conference.end_date + 5.days, description: 'Survey about the conference. You can already see it.')
  ...
  task test: :environment do
    def generate_program(conference)
      ...
      selected_schedule = create(:schedule, program:)
      demo_schedule = create(:schedule, program:)
      program.update_attribute(:selected_schedule, selected_schedule)

      create(:event, program:, title: 'Demo Event',
abstract: 'This is a demo event instance whose state not defined.')
      create(:event, program:, title: 'Demo Rejected Event', state: 'rejected',
abstract: 'This is demo event instance in a rejected state.')
      create(:event, program:, title: 'Demo Unconfirmed Event', state: 'unconfirmed',
abstract: 'This is a demo event instance in unconfirmed state.')
      create(:event, program:, title: 'Demo Confirmed Unscheduled Event', state: 'confirmed',
abstract: 'This is a demo event instance in a confirmed state.')

      first_scheduled_event = create(:event, program:, title: 'first_scheduled_event', state: 'confirmed',
abstract: 'This is a demo scheduled event instance.', superevent: true)
      ...
      multiple_speaker_event = create(:event, program:, title: 'multiple_speaker_event', state: 'confirmed',
abstract: 'This is a demo scheduled event instance having multiple speakers.')
      first_scheduled_subevent = create(:event, program:, title: 'first_scheduled_subevent',
state: 'confirmed', abstract: 'This is a demo scheduled subevent instance having multiple speakers.', superevent: false, parent_id: first_scheduled_event.id)
      ...
      create(:event_schedule, event: first_scheduled_event, schedule: selected_schedule,
start_time: conference.start_date + conference.start_hour.hours, room: conference_rooms.first)
      create(:event_schedule, event: first_scheduled_subevent, schedule: selected_schedule,
start_time: conference.start_date + conference.start_hour.hours, room: conference_rooms.first)
      ...
      create(:event_schedule, event: multiple_speaker_event, schedule: selected_schedule,
start_time: conference.start_date + conference.start_hour.hours + 30.minutes, room: conference_rooms.third)
      create(:event_schedule, event: first_scheduled_event, schedule: demo_schedule,
start_time: conference.start_date + conference.start_hour.hours + 15.minutes, room: conference_rooms.third)
      ...
      create(:event_schedule, event: multiple_speaker_event, schedule: demo_schedule,
start_time: conference.start_date + conference.start_hour.hours, room: conference_rooms.first)

      create(:registration, user: user1, conference:)
      create(:registration, user: user2, conference:)
    end

    # Create a new admin user
    create(:admin, email: 'admin@osem.io', username: 'admin', password: 'password123',
password_confirmation: 'password123', timezone: 'Sydney')
    ...
    conference = create(:full_conference, title: 'Open Source Event Manager Demo Conference', short_title: 'osemdemo',
start_date: 2.days.from_now, end_date: 6.days.from_now, start_hour: 8, end_hour: 20, description: 'This is a full conference demo instance happening in the future. It contains open cfp, venue/rooms, submitted talks by multiple speakers, partly confirmed talks and multiple schedules.', timezone: 'America/Los_Angeles')
    ...
    conference = create(:full_conference, title: 'Jangouts Demo Conference', short_title: 'jangouts',
start_date: 7.days.ago, end_date: 6.days.from_now, start_hour: 15, end_hour: 20, description: 'This is a full conference demo instance happened in the past. It contains open cfp, venue/rooms, submitted talks by multiple speakers, partly confirmed talks and multiple schedules.')
    ...
    conference = create(:conference, title: 'Portus Demo Conference', short_title: 'portus',
registration_period:, start_date: 3.days.from_now, end_date: 7.days.from_now, start_hour: 10, end_hour: 15, description: 'This is a demo conference instance. No information about this conference is set by default.')
    create(:event, program: conference.program, title: 'Demo Event',
abstract: 'This is a demo event instance whose state not defined.')
    create(:event, program: conference.program, title: 'Demo Rejected Event', state: 'rejected',
abstract: 'This is demo event instance in a rejected state.')
    create(:event, program: conference.program, title: 'Demo Unconfirmed Event', state: 'unconfirmed',
abstract: 'This is a demo event instance in unconfirmed state.')
    create(:event, program: conference.program, title: 'Demo Confirmed Event', state: 'confirmed',
abstract: 'This is a demo event instance in a confirmed state.')
    ...
    conference = create(:full_conference, title: 'Yast Demo Conference', short_title: 'yast',
registration_period:, start_date: 2.days.ago, end_date: 7.days.from_now, start_hour: 10, end_hour: 21, description: 'This is a full conference demo instance. Its registration period is closed.')
    generate_program conference

    # This is a full conference demo instance that will happen in the future.
    # By full conference it means all basic information about conference is already set.
    # Registration for this conference has reached its limit.
    conference = create(:full_conference, title: 'Zypper Docker  Conference', short_title: 'zypper',
registration_limit: 2, start_date: 3.days.from_now, end_date: 7.days.from_now, start_hour: 7, end_hour: 19, description: 'This is a full conference demo instance. Its registrations has reached the limit.')
    generate_program conference
  end
end
